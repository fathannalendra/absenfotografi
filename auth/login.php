...
if (isset($_POST['login'])) {
    ...
    $result = mysqli_query($conn, "SELECT * FROM users  JOIN anggota ON users.id_anggota = anggota.id WHERE username = '$username'");
        ...
        if (password_verify($password, $row['password'])) {
            if ($row['status'] == 'Aktif') {
                ...
                if ($row['role'] === 'Admin') {
                    ...
                    header("location: ../anggota/home/home.php");
                    exit();
                }
            } else {
            ...
            $_SESSION['gagal'] = 'Password anda salah, silahkan coba lagi';
        }
    } else {
        $_SESSION['gagal'] = 'Username anda salah, silahkan coba lagi';
    }
}
...
<body class=" d-flex flex-column bg-white">
    ...
    <div class="row g-0 flex-fill">
            ...
            <div class="container container-tight my-5 px-lg-5">
                <div class="text-center mb-4">
                    <a href="." class="navbar-brand navbar-brand-autodark"><img
                            src="<?php echo base_url('assets/img/logofoga.png') ?>" height="36" alt=""></a>
                </div>
                <?php
                ...
                <form action="" method="POST" autocomplete="off" novalidate>
                    ...
                    <div class="text-start">
                        <a href="<?php echo base_url('auth/ubah_password.php') ?>" tabindex="-1">Forgot Password?</a>
                    </div>
                ...
                <div class="text-center text-secondary mt-3">
                    Don't have account yet? <a href="<?php echo base_url('auth/signup.php') ?>" tabindex="-1">Sign
                        up</a>
                </div>
            </div>
        </div>
        <div class="col-12 col-lg-6 col-xl-8 d-none d-lg-block">
            <!-- Photo -->
            <div class="bg-cover h-100 min-vh-100" style="background-image: url('../assets/img/coverlogin.jpg')"></div>
        </div>
    </div>
    <!-- Libs JS -->
    <script src="<?php echo base_url('assets/libs/apexcharts/dist/apexcharts.min.js?1692870487') ?>" defer></script>
    <script src="<?php echo base_url('assets/libs/jsvectormap/dist/js/jsvectormap.min.js?1692870487') ?>"
        defer></script>
