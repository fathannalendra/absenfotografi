...
$result = mysqli_query($conn, "SELECT presensi.* , anggota.nama, anggota.kelas FROM presensi JOIN anggota ON presensi.id_anggota = anggota.id 
WHERE tanggal_masuk BETWEEN '$tanggal_dari' AND '$tanggal_sampai' ORDER BY tanggal_masuk DESC");
